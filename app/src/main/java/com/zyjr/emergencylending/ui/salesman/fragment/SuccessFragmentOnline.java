...
public class SuccessFragmentOnline extends BaseFragment implements XListView.IXListViewListener{
    @BindView(R.id.xlv)
    XListView xlv;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_success_online, container, false);
